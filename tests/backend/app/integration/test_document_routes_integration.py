# tests/backend/app/integration/test_document_routes_integration.py
#
...
async def test_preview_compiles_on_the_fly_without_persisting(client, created_emails, _mock_pdf_rendering):
    ...
    # entirely (see fetchResumeTemplatePreviewBlob's docstring in
    # frontend/src/app/api/document_api.ts).
