...
Per the design decision that role must be pure metadata (display/grouping)
and never an authorization mechanism, the system "must support ... users
without roles". A NOT NULL role column makes that literally
