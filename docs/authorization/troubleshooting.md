...
> Inherited unmodified from [mystic-auth](https://github.com/Nachiket-2024/mystic-auth), confirmed byte-identical to upstream as of this review. See [ManifestCV's own Testing Overview](../testing/overview.md#troubleshooting) for ManifestCV-specific test-running gotchas (e.g. the frontend container's test mount).
